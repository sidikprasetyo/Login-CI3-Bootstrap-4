...
class Auth extends CI_Controller {
    ...
    public function registration(){
        ...
        if($this->form_validation->run() == false){
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Congratulation! Your your account has been created. Please activated your account.</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type){
        $config = [
            ...
            'smtp_user' => 'sidik.vbnetti21a4@gmail.com', //use your email to set server
            'smtp_pass' => 'sephemwkmhmrvpde', //use your app pasword from google
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('sidik.vbnetti21a4@gmail.com', 'Sidik Prasetyo Login');
    ...
    public function changePassword(){
        ...
        if($this->form_validation->run() == false){
            ...
            // Use the set method to set the new password
